    ...
    public partial class Init : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.Message_Id, t.Media_Id })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.MessageMedias", "Media_Id", "dbo.Media");
            DropForeignKey("dbo.MessageMedias", "Message_Id", "dbo.Messages");
            DropIndex("dbo.MessageMedias", new[] { "Media_Id" });
            DropIndex("dbo.MessageMedias", new[] { "Message_Id" });
